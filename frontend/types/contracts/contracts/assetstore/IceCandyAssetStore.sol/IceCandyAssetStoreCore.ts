...
export interface IceCandyAssetStoreCoreInterface extends utils.Interface {
  functions: {
...
export interface IceCandyAssetStoreCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IceCandyAssetStoreCoreInterface;
