...
export interface IIceCandyAssetStoreInterface extends utils.Interface {
  functions: {
    "getAsset(uint256)": FunctionFragment;
    "getAssetCount()": FunctionFragment;
    "owner()": FunctionFragment;
    "registerAsset((string,address,string))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [IIceCandyAssetStore.AssetStruct]
  ): string;
  encodeFunctionData(
...
export interface IIceCandyAssetStore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIceCandyAssetStoreInterface;
  ...
  functions: {
    ...
    registerAsset(
      arg0: IIceCandyAssetStore.AssetStruct,
